...
Soy un profesional que combina **ciencia, tecnología y educación** para crear soluciones digitales en el ámbito de la salud.  
Mi enfoque está en el **diseño de experiencias de aprendizaje, automatización de procesos sanitarios** y el **desarrollo de software aplicado al sector salud**.

- 🧠 **Formación:** Médico con Especialización en Gerencia de la Salud Pública.  
- 💻 **Perfil técnico:** Full-Stack Developer con experiencia en **CodeIgniter, Laravel, React, Next.js y Spring Boot**.  
- 🧩 **Áreas de interés:** Interoperabilidad en salud, plataformas e-learning, automatización y analítica de datos.  
- 🎨 **Diseño:** Amante de la simplicidad, el diseño minimalista y la usabilidad centrada en el usuario.  
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,php,java,react,nextjs,laravel,codeigniter,nodejs,postgres,mysql,redis,docker,figma,illustrator,git&theme=light" />
</p>
...
- 🧬 Creación de **ecosistemas e-learning** para instituciones de salud y universidades.  
- 🤖 Integración de **IA y automatización de procesos clínicos** con herramientas como n8n y Playwright.  
- 📚 Desarrollo de contenidos interactivos para **capacitación médica y científica**.  
- 🧱 Construcción de **componentes UI reutilizables** para proyectos en CodeIgniter y React.  
...
> “La tecnología no reemplaza al profesional de la salud: lo potencia.”

Creo en la innovación con propósito: cada línea de código, cada diseño y cada proyecto deben **mejorar la vida de las personas**.  
Mi enfoque combina el rigor científico con la creatividad tecnológica.
...
<p align="center">
  <sub>🩺 Desarrollando soluciones donde la salud, la educación y la tecnología se encuentran.</sub>
</p>
